...
public class R_inv_telefonoDa_def_delete_r_inv_telefonoController extends AbstractObjectDeleteController<F_involucradoToB_telefonoAssociation> {
    public R_inv_telefonoDa_def_delete_r_inv_telefonoController() {
        super(F_involucradoToB_telefonoAssociation.class);
    }
}