...
public class F_involucradoToB_declaracionjuradaAssociation {
    ...
    private B_declaracionjuradaTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_declaracionjuradaTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_declaracionjuradaTargetRelation child){
        this.child = child;
    }
