...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("declaracion_jurada")
    private List<F_involucradoToB_declaracionjuradaAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_declaracionjuradaAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_declaracionjuradaAssociation> parentChildAssociation){
