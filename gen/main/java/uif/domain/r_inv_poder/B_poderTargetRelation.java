...
@PersistentObject(superType = "dm_sysobject", type = "uif_b_poder")
@JsonPropertyOrder(alphabetic = true)
@JsonIgnoreProperties(value = {"dirty"})
public class B_poderTargetRelation {
    ...
    private F_involucradoToB_poderAssociation parentChildAssociation;
    ...
    public F_involucradoToB_poderAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_poderAssociation parentChildAssociation){
