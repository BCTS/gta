...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("exportacion")
    private List<F_involucradoToB_exportacionAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_exportacionAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_exportacionAssociation> parentChildAssociation){
