...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("activo")
    private List<F_involucradoToB_activoAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_activoAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_activoAssociation> parentChildAssociation){
