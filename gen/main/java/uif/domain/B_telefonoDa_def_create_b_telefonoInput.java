...
@PersistentObject(type = "uif_b_telefono")
@Linked(template = "/application/uif_b_telefonos")
@JsonPropertyOrder(alphabetic = true)
public class B_telefonoDa_def_create_b_telefonoInput {
    ...
    @PersistentAttribute(name = "comentario")
