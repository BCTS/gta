...
@PersistentObject(type = "uif_b_cuenta_bancaria")
@Linked(template = "/application/uif_b_cuenta_bancarias")
@JsonPropertyOrder(alphabetic = true)
public class B_cuenta_bancariaDa_def_create_b_cuenta_bancariaInput {
