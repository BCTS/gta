...
public class F_involucradoSourceRelation {
    ...
    private List<F_involucradoToB_identificacionAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_identificacionAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_identificacionAssociation> parentChildAssociation){
