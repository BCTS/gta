...
@PersistentObject(superType = "dm_sysobject", type = "uif_b_identificacion")
@JsonPropertyOrder(alphabetic = true)
@JsonIgnoreProperties(value = {"dirty"})
public class B_identificacionTargetRelation {
    ...
    private F_involucradoToB_identificacionAssociation parentChildAssociation;
    ...
    public F_involucradoToB_identificacionAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_identificacionAssociation parentChildAssociation){
