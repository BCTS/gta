...
public class F_involucradoToB_importacionAssociation {
    ...
    private B_importacionTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_importacionTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_importacionTargetRelation child){
        this.child = child;
    }
