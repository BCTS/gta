...
@PersistentObject(superType = "dm_sysobject", type = "uif_b_importacion")
@JsonPropertyOrder(alphabetic = true)
@JsonIgnoreProperties(value = {"dirty"})
public class B_importacionTargetRelation {
    ...
    private F_involucradoToB_importacionAssociation parentChildAssociation;
    ...
    public F_involucradoToB_importacionAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_importacionAssociation parentChildAssociation){
