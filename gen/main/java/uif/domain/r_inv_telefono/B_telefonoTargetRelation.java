...
@PersistentObject(superType = "dm_sysobject", type = "uif_b_telefono")
@JsonPropertyOrder(alphabetic = true)
@JsonIgnoreProperties(value = {"dirty"})
public class B_telefonoTargetRelation {
    ...
    private F_involucradoToB_telefonoAssociation parentChildAssociation;
    ...
    public F_involucradoToB_telefonoAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_telefonoAssociation parentChildAssociation){
