...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("telefonos")
    private List<F_involucradoToB_telefonoAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_telefonoAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_telefonoAssociation> parentChildAssociation){
