...
public class F_involucradoToB_accionAssociation {
    ...
    private B_accionTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_accionTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_accionTargetRelation child){
        this.child = child;
    }
