...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("accion")
    private List<F_involucradoToB_accionAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_accionAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_accionAssociation> parentChildAssociation){
