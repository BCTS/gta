...
@PersistentObject(type = "uif_b_identificacion")
@Linked(template = "/application/uif_b_identificacions")
@JsonPropertyOrder(alphabetic = true)
public class B_identificacionDa_def_update_b_identificacionInput {
    ...
    @PersistentAttribute(name = "vericidad")
    private String vericidad;
    ...
    public String getVericidad(){
        return vericidad;
    }

    public void setVericidad(String vericidad){
        this.vericidad = vericidad;
    }
