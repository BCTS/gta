...
public class F_involucradoSourceRelation {
    ...
    @OneToOne
    @PersistentTypedRelationship(type = "uif_r_inv_financiamien")
    @ReferredName("Financiamiento")
    private F_involucradoToB_financiamientoAssociation parentChildAssociation;
    ...
    public F_involucradoToB_financiamientoAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_financiamientoAssociation parentChildAssociation){
