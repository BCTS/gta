...
public class F_involucradoToB_financiamientoAssociation {
    ...
    private B_financiamientoTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_financiamientoTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_financiamientoTargetRelation child){
        this.child = child;
    }
