...
public class F_involucradoToB_viajeAssociation {
    ...
    private B_viajeTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_viajeTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_viajeTargetRelation child){
        this.child = child;
    }
