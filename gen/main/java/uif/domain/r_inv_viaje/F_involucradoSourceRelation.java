...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("viaje")
    private List<F_involucradoToB_viajeAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_viajeAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_viajeAssociation> parentChildAssociation){
