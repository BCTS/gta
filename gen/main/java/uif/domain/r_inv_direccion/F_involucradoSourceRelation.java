...
public class F_involucradoSourceRelation {
    ...
    private List<F_involucradoToB_direccionAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToB_direccionAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToB_direccionAssociation> parentChildAssociation){
