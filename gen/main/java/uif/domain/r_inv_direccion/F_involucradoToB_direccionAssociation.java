...
public class F_involucradoToB_direccionAssociation {
    ...
    private B_direccionTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public B_direccionTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(B_direccionTargetRelation child){
        this.child = child;
    }
