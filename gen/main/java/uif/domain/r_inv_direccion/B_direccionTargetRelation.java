...
public class B_direccionTargetRelation {
    ...
    private F_involucradoToB_direccionAssociation parentChildAssociation;
    ...
    public F_involucradoToB_direccionAssociation getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(F_involucradoToB_direccionAssociation parentChildAssociation){
