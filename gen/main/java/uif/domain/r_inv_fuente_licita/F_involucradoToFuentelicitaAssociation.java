...
public class F_involucradoToFuentelicitaAssociation {
    ...
    private FuentelicitaTargetRelation child;
    ...
    @JsonSerialize(using = EntityAsIdSerializer.class)
    public FuentelicitaTargetRelation getChild(){
        return child;
    }

    @JsonIgnore
    public void setChild(FuentelicitaTargetRelation child){
        this.child = child;
    }
