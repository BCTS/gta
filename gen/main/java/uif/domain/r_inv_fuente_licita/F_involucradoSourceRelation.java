...
public class F_involucradoSourceRelation {
    ...
    @ReferredName("fuente_licita")
    private List<F_involucradoToFuentelicitaAssociation> parentChildAssociation;
    ...
    public List<F_involucradoToFuentelicitaAssociation> getParentChildAssociation(){
        return parentChildAssociation;
    }

    @JsonIgnore
    public void setParentChildAssociation(List<F_involucradoToFuentelicitaAssociation> parentChildAssociation){
